...
class MarsRoverTest {
    ...
    @Test
    void should_mov_backward_when_executeCommand_given_B_and_Direction_is_E(){
        // Given
        Location location = new Location(0,0, Direction.E);
        MarsRover marsRover = new MarsRover(location);
        // When
    ...
    @Test
    void should_mov_backward_when_executeCommand_given_B_and_Direction_is_S(){
        // Given
        Location location = new Location(0,0, Direction.S);
        MarsRover marsRover = new MarsRover(location);
        // When
    ...
    @Test
    void should_mov_backward_when_executeCommand_given_B_and_Direction_is_W(){
        // Given
        Location location = new Location(0,0, Direction.W);
        MarsRover marsRover = new MarsRover(location);
        // When
